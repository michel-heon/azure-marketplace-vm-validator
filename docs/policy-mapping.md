...
| `test_2005_no_pending_security_updates.sh` | 200.5.x | No pending security updates (`apt-get -s upgrade`) | FAIL | ubuntu | distro adapter: `ctt_pkg_update_security_check_cmd` |
